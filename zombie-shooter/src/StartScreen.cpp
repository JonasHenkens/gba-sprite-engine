...
void StartScreen::load() {
    ...
    backgroundPalette = std::unique_ptr<BackgroundPaletteManager>(new BackgroundPaletteManager(startscreenimage2Pal, sizeof(startscreenimage2Pal)));
    ...
    bg = std::unique_ptr<Background>(new Background(0, startscreenimage2Tiles, sizeof(startscreenimage2Tiles), startscreenimage2Map, sizeof(startscreenimage2Map)));
